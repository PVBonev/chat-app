...
import com.example.demo4.appuser.AppUserRole;
import com.example.demo4.appuser.AppUserService;
import com.example.demo4.email.EmailSender;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        LOGGER.info("confirmToken: " + token);
        ...
        appUserService.enableAppUser(confirmationTokenEntity.getAppUserEntity().getEmail());
